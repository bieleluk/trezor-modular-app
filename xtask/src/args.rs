...
#[command(
    override_usage = "xtask build --app <APP> --model <MODEL> --language <LANGUAGE> --log_level <LOG_LEVEL> [OPTIONS]"
)]
...
pub struct UploadArgs {
    #[arg(long, short = 'p', default_value = "funnycoin_rust")]
    pub project: String,
