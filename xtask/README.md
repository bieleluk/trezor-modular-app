...
```sh
nix-shell
cargo xtask build -p funnycoin_rust --model t3w1 --lang en --log-level trace --emulator
cargo xtask unit-tests -p funnycoin_rust --model t3t1 --lang cs 
cargo xtask clippy 
cargo xtask device-tests -p funnycoin_rust -m t3w1
